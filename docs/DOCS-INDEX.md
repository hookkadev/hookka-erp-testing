...
- `docs/T-010-OCR-SCAN.md` — **OCR scan design (PRD T-010)**: two-stage extraction + the two 1-hour cache breakpoints, the correction → alias → distill loop, original-document retention, and what is still UNMEASURED / not done. Branch `feat/t010-ocr-scan`.
