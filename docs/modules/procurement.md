...
> **Last verified: 2026-09-22** (supplier-payments.ts anchors re-derived after the `buildSupplierPaymentCreate` extraction; the rest carries the 2026-08-19 stamp) against `src/api/routes/{purchase-orders,grn,purchase-invoices,three-way-match,supplier-payments,supplier-materials}.ts`,
