...
| `filteredOrders` (memo) | `src/pages/production/index.tsx:2841` | Dept-narrow + overdue-set grid filter |
| `loadFgStickers` / `packingStickerUrl` | `src/pages/production/index.tsx:5513 / 5472` | FG sticker set (immediate paint → /p/ token upgrade) |
