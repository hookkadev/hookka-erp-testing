    ...
    <div className="space-y-5 max-md:space-y-4">
      ...
      {sub === "overdue" && (
        <>
          ...
          {/* PLACEHOLDER — the lead replaces this card with <ServiceApprovalsPanel />
              (built separately, arrives with the Service tab). */}
          <Card>
            <CardHeader className="pb-2"><CardTitle>Service case approvals</CardTitle></CardHeader>
            <CardContent className="text-sm text-[#6B7280]">Arrives with the Service tab.</CardContent>
          </Card>
        </>
      )}
    </div>
